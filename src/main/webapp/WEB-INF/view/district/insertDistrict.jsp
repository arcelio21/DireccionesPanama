...
<html>
  ...
  <body class="container">
      ...
      <div id="form" class="col-6 ">
          <f:form action="insert?idProv=${idProv}" modelAttribute="distritc" method="post">
              ...
              <f:select path="idProvincefk.id" id="idProv" cssClass="form-select">
                  <c:forEach items="${provinces}" var="province">

                      <f:option value="${province.id}" label="${province.name}" />
