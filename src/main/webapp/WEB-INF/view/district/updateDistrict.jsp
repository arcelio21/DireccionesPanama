...
<html>
    ...
    <body class="container">
        ...
        <header id="head" class="col-6 mb-3 ">
            <h1>Actualizar Datos de distritos</h1>
        ...
        <div id="form" class="col-6 ">
            <f:form action="update?idProv=${idProv}" modelAttribute="district" method="post">
                ...
                <f:label path="idProvincefk"  cssClass="form-label">
                    Provincia
                </f:label>

                <f:select path="idProvincefk.id" id="province" cssClass="form-select" >
                    <f:option value="${district.idProvincefk.id}" label="${district.idProvincefk.name}" />
