...
<html>
    ...
    <div class="headBtn">
        ...
        <a class="btn btn-warning mb-3" href="${pageContext.request.contextPath}${urlDistrict}"> <!--VALIDAR ARGUMENTO PARA FILTRAR, PARA PORDER FILTRAR POR DISTRITO-->
        ...
        <a href="new?idDist=${idDist}&idProv=${idProv}"  class="btn btn-success mb-3">Agregar nuevo</a>
    </div>
